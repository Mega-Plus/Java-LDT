...
public class SQL {
    ...
    public static String DB_HOST = "192.168.1.5";
    private static int DB_PORT = 1433;
    public static String DB_NAME = "FM2";
    public static String USER = "FM2";
    public static String PASSWORD = "#$%1018545246ERT";
...
//                conn = DriverManager.getConnection(connString, USER, PASSWORD);
                String connString = "jdbc:jtds:sqlserver://192.168.1.5:1433;databaseName=FM2;user=FM2;password=#$%1018545246ERT";
    ...
    public static ResultSet SQL_ResultSet(String QUERY) {
        ...
        while (mediator_SQL_ResultSet == null) {
            ...
            if (count_ResultSet > 2) {
                mediator_SQL_ResultSet = SQL_ResultSet(QUERY);
