...
public class ListItem {
    ...
    public ListItem(String P_BARCODE, String P_NAME_SALE, String P_PRICE, String CurrentDate, String P_GOODSGROUP, String P_DEFAULTSUPPLIER, String P_UUID, int quantity) {
